...
def _register_fonts():
    ...
    pdfmetrics.registerFont(TTFont("DSR",  "/usr/share/fonts/truetype/dejavu/DejaVuSerif.ttf"))
    pdfmetrics.registerFont(TTFont("DSB",  "/usr/share/fonts/truetype/dejavu/DejaVuSerif-Bold.ttf"))
    pdfmetrics.registerFont(TTFont("DSI",  "/usr/share/fonts/truetype/dejavu/DejaVuSerif-Italic.ttf"))
    pdfmetrics.registerFont(TTFont("DSBI", "/usr/share/fonts/truetype/dejavu/DejaVuSerif-BoldItalic.ttf"))
