...
def generate_paradosi_pdf(data: dict) -> io.BytesIO:
    ...
    story.append(Paragraph(
        ...
        f"παρέδωσεν εις τον εκλεγέντα νέον Γραμματέα-Σφραγιδοφύλακα "
        f"<b>Αδ∴ {data['παραλαμβάνων']}</b> τα κατωτέρω, "
        f"ήτοι το σύνολον των αρχείων, βιβλίων, εγγράφων, της σφραγίδος και της γραφικής ύλης "
        f"της Σ∴ Στ∴ μας, συμφώνως πρός τα οριζόμενα εις τα Άρθρα 35-41 του Γενικού Κανονισμού "
        f"της Μεγάλης Στοάς της Ελλάδος (Γ.Κ. ΜΣΤΕ).", BOD))
    ...
    # ── ΝΟΜΙΚΗ ΔΕΣΜΕΥΣΗ ──────────────────────────────────────
    story.append(hr())
    story.append(Paragraph("ΣΤ. ΝΟΜΙΚΗ ΔΕΣΜΕΥΣΙΣ & ΥΠΕΥΘΥΝΟΤΗΤΑ", BLD))
    story.append(Paragraph(
        f"Ο Απερχόμενος Γραμματεύς-Σφραγιδοφύλαξ <b>Αδ∴ {data['απερχόμενος']}</b> "
        f"βεβαιοί δι' υπογραφής του ότι παρέδωσεν άπαντα τα ανωτέρω αντικείμενα και έγγραφα, "
        f"εν πλήρει γνώσει των υποχρεώσεών του εκ των Άρθρων 35-41 του Γ.Κ. ΜΣΤΕ. "
        f"Ο Νέος Γραμματεύς-Σφραγιδοφύλαξ <b>Αδ∴ {data['παραλαμβάνων']}</b> "
        f"βεβαιοί δι' υπογραφής του ότι παρέλαβε τα ανωτέρω, αφού διεπίστωσεν την κατάστασίν των.", BOD))
