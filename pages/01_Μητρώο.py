...
# Αξιώματα Στοάς
ΑΞΙΩΜΑΤΑ_ΣΤΟΑΣ = [
    "", "Σεβάσμιος", "Πρώην Σεβάσμιος", "Α' Επόπτης", "Β' Επόπτης", "Ρήτωρ",
    "Γραμματεύς-Σφραγιδοφύλαξ", "Ταμίας", "Α' Δοκιμαστής", "Β' Δοκιμαστής",
    "Ελεονόμος", "Τελετάρχης", "Στεγαστής", "Πρόσθετος Ρήτωρ", "Μεγάλος Επιθεωρητής",
]
ΑΞΙΩΜΑΤΑ_ΜΣ = [
