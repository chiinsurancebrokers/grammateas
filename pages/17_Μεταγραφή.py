...
ΠΑΡΑΔΕΙΓΜΑ ΣΩΣΤΗΣ ΕΝΟΤΗΤΑΣ «ΟΜΙΛΙΑΙ ΕΠΙ ΤΗΣ ΟΜΙΛΙΑΣ»:
---
...
ΚΡΙΣΙΜΟ για τους χαιρετισμούς:
• Ο Μέγας Στεγαστής = «Ένδοξε Μέγ∴ Αξ∴» → ΤΑΞΗ 5 (πριν από πρώην Σεβ∴ που είναι ταξη 12)
• Πρώην Σεβάσμιοι = «Πρώην Σεβάσμιος» → ΤΑΞΗ 12
• ΠΑΝΤΑ ταξινόμησε χαιρετισμούς: Ένδοξε Μέγ∴ Αξ∴ πρώτος, μετά οι Πρώην Σεβάσμιοι
• Μορφή: "Ένδοξε Μέγ∴ Αξ∴ Δημήτριος Δενδεδιός — Μέγας Στεγαστής Μ∴Σ∴Τ∴Ε∴"
• Μορφή: "Πρώην Σεβάσμιος Ελευθέριος Κεσσανής — πρώην Σεβάσμιος Σ∴ Στ∴"
...
4. ΠΕΝΘΙΜΗ ΧΕΙΡΟΚΡΟΥΣΙΑ (αν υπάρχει)
   Ο Φιλτ∴ Αδ∴ Σεβ∴ κάλεσε το πλήρωμα να αποδώσει πενθίμια χειροκρουσία
   εις μνήμην του [ΟΝΟΜΑ], [ΑΞΙΩΜΑ]. Το Εργαστήριο απέδωσε την πενθίμια
   χειροκρουσία τιμής ένεκεν.
...
• "εχαράχθησαν" → γράψε "καταχωρήθηκαν"
