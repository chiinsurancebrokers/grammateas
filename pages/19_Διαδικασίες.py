        ...
        "input_groups": [
            {
                ...
                "fields": [
                    ...
                    ("ax_xifok",  "Ξιφοκόρος-Σηματοφόρος","member", ""),
                ],
            },
            {
...
Σου δίνεται ένα πρότυπο εντύπου ΜΣΤΕ και τα στοιχεία που συμπλήρωσε ο χρήστης.
Επέστρεψε ΜΟΝΟ valid JSON object με τα κλειδιά να είναι ΑΚΡΙΒΩΣ
το κείμενο του placeholder/κενού που εμφανίζεται στο έντυπο (όπως "Ονοματεπώνυμο ........")
και οι τιμές να είναι η συμπλήρωση.

Κανόνες:
- Χρησιμοποίησε επίσημη, αρχαιοπρεπή τεκτονική γλώσσα
- Συντομογραφίες: Σεβ∴ Διδ∴, Αδ∴, Σ∴ Στ∴, Μεγ∴ κλπ
- Αν κάποιο πεδίο δεν έχει δεδομένα, άφησε κενό ""
- Επέστρεψε ΜΟΝΟ JSON, χωρίς markdown, χωρίς backticks
""".strip()
...
Δεδομένα που έδωσε ο χρήστης:
{json.dumps(user_data, ensure_ascii=False, indent=2)}

Πρότυπο Εντύπου (κείμενο):
{form_template_text[:3000]}

Συμπλήρωσε το έντυπο και επέστρεψε JSON με {{placeholder: συμπλήρωση}}.
""".strip()
